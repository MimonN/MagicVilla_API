...
namespace MagicVilla_VillaAPI.Controllers
{
    ...
    public class VillaNumberAPIController : ControllerBase
    {
        ...
        private readonly IVillaNumberRepositrory _dbVillaNumber;
        private readonly IVillaRepositrory _dbVilla;
        private readonly IMapper _mapper;
        public VillaNumberAPIController(IVillaNumberRepositrory dbVillaNumber, IMapper mapper, IVillaRepositrory dbVilla)
        {
